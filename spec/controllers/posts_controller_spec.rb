...
RSpec.describe PostsController, type: :controller do
  ...
  # We add a context for a guest (un-signed-in) user. Contexts organize tests based on the state of an object.
  context "guest user" do
    ...
    # We define tests for the other CRUD actions. We won't allow guests to access the  create, new, edit, update, or destroy actions.
    describe "GET new" do
