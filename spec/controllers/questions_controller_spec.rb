...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "GET edit" do
    ...
    it "renders the #edit view" do
      get :edit, {id: my_question.id}
        # We expect the edit view to render when a question is edited.
  ...
  describe "PUT update" do
    it "updates question with expected attributes" do
      ...
      # We test that @question was updated with the title and body passed to update. We also test that @question's id was not changed.
    ...
    it "redirects to the updated question" do
      ...
      # We expect to be redirected to the questions show view after the update.
