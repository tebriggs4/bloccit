...
RSpec.describe Post, type: :model do
    ...
    describe "voting" do
        ...
        describe "#update_rank" do
            # We expect that a post's rank will be determined by using a time-decay algorithm like this will keep our post ranks fresh.
    ...
    describe "#create_vote" do
        it "sets up_vote to 1 when the post is created" do
            expect(post.up_votes).to eq(1)
        end
        
        it "assigns user vote with owner of the post" do
            expect(post.votes.first.user).to eq(post.user)
        end
        
        it "expects to call #create_vote when a new post is created" do
